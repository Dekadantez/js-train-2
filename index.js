...
function calculateExpression(expression) {
  let result = console.log(eval(expression));

  return eval(expression) ? result : "Argument is not a string";
  //Преревіряємо чи аргумент є рядком
  //Якщо так повертаємо виконананий код  return isFinite(result) ? result : null;
